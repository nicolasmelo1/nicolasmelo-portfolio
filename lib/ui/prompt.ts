  ...
  return {
    system: [
      ...
      [
        ...
        "- A share the payload actually states, such as a repository's language percentages: a Meter each. Never a Meter for a number you had to invent.",
      ...
      [
        ...
        '- "extend" is a comparison that needs the old subject and a new one at once. Keep what answers it, remove what does not, and put the two sides where they can be read against each other. A Table is usually the right answer; Tabs or `columns` on the root are the alternatives.',
